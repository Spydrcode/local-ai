  ...
  const demos = [
    {
      ...
      icon: "🎯",
      description: "See how Local AI analyzes your business and generates actionable marketing strategies",
    },
    {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="mb-6 text-5xl font-bold text-white sm:text-6xl">
              See Local AI in <span className="bg-linear-to-r from-emerald-400 to-green-500 bg-clip-text text-transparent">Action</span>
            </h1>
